 ...
 * @author ©Povodev
 */
public class CancellaIscrizioneGruppo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ServiceGruppiUtente.elimina(utente.getId(),idGruppo);
        } catch (SQLException ex) {
            Logger.getLogger(CancellaIscrizioneGruppo.class.getName()).log(Level.SEVERE, null, ex);
        }
